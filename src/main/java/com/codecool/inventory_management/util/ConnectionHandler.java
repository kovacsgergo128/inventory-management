...
public class ConnectionHandler {
    ...
    private static final ConnectionString CONNECTION_STRING = new ConnectionString(
            "mongodb://inventory-user_1:inventory-user_1@inventory-management-shard-00-00-mvcox.mongodb.net:27017," +
                    "inventory-management-shard-00-01-mvcox.mongodb.net:27017," +
                    "inventory-management-shard-00-02-mvcox.mongodb.net:27017/test" +
                    "?ssl=true&replicaSet=Inventory-management-shard-0&authSource=admin&retryWrites=true&w=majority"
    );
